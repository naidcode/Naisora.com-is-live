  ...
  return (
    <footer className="relative bg-bg pt-24 pb-12 overflow-hidden border-t border-stroke">
      ...
      <div className="container relative z-10 px-6 mx-auto">
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pt-12 border-t border-stroke">
          <div className="flex items-center gap-6">
            <Link href="/" className="group transition-transform hover:scale-105 active:scale-95 mr-4">
          ...
          <div className="flex items-center gap-3 bg-surface/30 px-4 py-2 rounded-full border border-stroke backdrop-blur-sm">
            <div className="relative flex h-2 w-2">
              <div className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></div>
              <div className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></div>
            </div>
            <span className="text-[10px] md:text-xs text-text-primary font-body font-medium uppercase tracking-wider">Available for projects</span>
          </div>

          <div className="text-[10px] md:text-sm text-muted font-body">
