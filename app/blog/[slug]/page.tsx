...
// FIX: Added all missing slugs that homepage links to
// Previously spice-garden-case-study and hidden-cost-delivery-apps were missing
// causing 404 on those pages
const BLOG_POSTS = [
  {
  ...
  // FIX: These two slugs were linked from homepage but missing here — caused 404
  {
